...
class LibMatch(object):
    ...
    def _compute_first_order_matches(self, lib):
        ...
        for faddr in lib.viable_functions:
            ...
            results = {bin_faddr for bin_faddr, bin_attrs in self.binary_lmd.function_attributes.iteritems()
    ...
    def _second_order_heuristic(cls, binary_lmd, lib_lmd, binary_faddr, lib_faddr):
        ...
        # TODO: perfect matching
        return FunctionDiff(binary_lmd, lib_lmd, bin_func, lib_func).probably_identical
    ...
    def _compute_second_order_matches(self, lib):
        ...
        for faddr, potential_matches in self._first_order_matches[lib].iteritems():
            self._second_order_matches[lib][faddr] = {maddr for maddr in potential_matches
                                                      if self._second_order_heuristic(self.binary_lmd, lib,
                                                                                      maddr, faddr)}
