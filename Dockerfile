...
RUN bash -c "source /home/angr/.local/bin/virtualenvwrapper.sh && workon angr && cd /home/angr/angr-dev/autoblob && pip install -e ."
COPY --chown=angr . /home/angr/angr-dev/libmatch
RUN bash -c "source /home/angr/.local/bin/virtualenvwrapper.sh && workon angr && cd /home/angr/angr-dev/libmatch && pip install -e ."
